...
export const testimonials = [
  {
    ...
    company: "ZenVue",
    location: "Pune, Maharashtra, India",
    text: "Found an amazing role within a week. The interview prep resources were a lifesaver.",
    rating: 5,
    avatar: "https://i.pravatar.cc/150?u=aisha-khan",
    bio: "Frontend engineer focusing on accessible, performant React apps.",
    social: { linkedin: "https://linkedin.com" },
    extra: "Referred 2 friends after joining.",
  },
  {
    id: "t2",
    name: "David Lee",
    ...
    text: "Excellent job matching. The recommendations were relevant and timely.",
    rating: 5,
  ...
  },
  {
    ...
    text: "Great UX and easy to apply. Loved the company insights.",
    rating: 5,
  ...
  },
  {
    ...
    rating: 5,
    avatar: "https://i.pravatar.cc/150?u=shahid-shaikh",
    bio: "Full-stack dev with a focus on Node.js and performance.",
    social: { twitter: "https://twitter.com" },
  },

  // More India-focused sample testimonials (random Indian names)
  {
    id: "t5",
    name: "Rohan Mehta",
    ...
    text: "Great platform — helped me find roles matching my skills quickly.",
    rating: 5,
  ...
  },
  {
    ...
    company: "DataCraft India",
    location: "Bengaluru, India",
    text: "Helpful filters and accurate job details. Highly recommended.",
    rating: 4,
  ...
  },
  {
    ...
    location: "Pune, India",
    text: "Easy to apply and great response time from companies.",
    rating: 5,
    avatar: "https://i.pravatar.cc/150?u=white",
  },
];